...
/**
 * This class provides a fluent builder API to help aid the configuration and instantiation of {@link DigitalTwinClient
 * DigitalTwinsClients} and {@link DigitalTwinAsyncClient DigitalTwinsAsyncClients}, call {@link #buildClient() buildClient} and {@link
 * #buildAsyncClient() buildAsyncClient} respectively to construct an instance of the desired client.
 */
@ServiceClientBuilder(serviceClients = {DigitalTwinClient.class, DigitalTwinAsyncClient.class})
public final class DigitalTwinsClientBuilder implements
    ...
    /**
     * The public constructor for at.jku.swe.simcomp.azureadapter.HelperClasses.DigitalTwinsClientBuilder
     */
    ...
    /**
     * Create a {@link DigitalTwinClient} based on the builder settings.
     *
     * @return the created synchronous DigitalTwinsClient
     * @throws IllegalStateException If both {@link #retryOptions(RetryOptions)}
     *      and {@link #retryPolicy(RetryPolicy)} have been set.
     */
    public DigitalTwinClient buildClient() {
        return new DigitalTwinClient(buildAsyncClient().toString());
    }

    /**
     * Create a {@link com.microsoft.azure.sdk.iot.service.digitaltwin.DigitalTwinAsyncClient} based on the builder settings.
     *
     * @return the created asynchronous DigitalTwinsAsyncClient
     * @throws IllegalStateException If both {@link #retryOptions(RetryOptions)}
     *      and {@link #retryPolicy(RetryPolicy)} have been set.
     */
    public DigitalTwinAsyncClient buildAsyncClient() {
        ...
        return new DigitalTwinAsyncClient(endpoint, tokenCredential);
    }
     ...
     * @return the updated at.jku.swe.simcomp.azureadapter.HelperClasses.DigitalTwinsClientBuilder instance for fluent building.
     */
    @Override
     ...
     * @return The updated at.jku.swe.simcomp.azureadapter.HelperClasses.DigitalTwinsClientBuilder object for fluent building.
     */
    @Override
     ...
     * @return The updated at.jku.swe.simcomp.azureadapter.HelperClasses.DigitalTwinsClientBuilder object.
     */
