...
/**
 * The at.jku.swe.simcomp.azureadapter.HelperClasses.DigitalTwinsModelData representing the model and its corresponding metadata.
 */
@Fluent
public final class DigitalTwinsModelData {
    ...
    /**
     * Construct a new at.jku.swe.simcomp.azureadapter.HelperClasses.DigitalTwinsModelData instance. This class should only be constructed internally since the
