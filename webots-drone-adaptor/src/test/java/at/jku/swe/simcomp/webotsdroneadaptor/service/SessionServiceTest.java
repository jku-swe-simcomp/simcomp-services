...
public class SessionServiceTest {
    ...
    DroneSessionService createSessionService() {
        return new DroneSessionService(simulationMock);
    }

    @Test
    void initializeSessionTest() throws Exception {

        try (MockedStatic<WebotsDroneSimulationInstanceService> mockedService = Mockito.mockStatic(WebotsDroneSimulationInstanceService.class)) {
            DroneSessionService sessionService = createSessionService();

            Set<SimulationInstanceConfig> instances = new HashSet<>();
            mockedService.when(WebotsDroneSimulationInstanceService::getInstances)
