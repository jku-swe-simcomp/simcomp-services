...
public class ResetToHomeExecutor implements CommandExecutor<ExecutionCommand.ResetToHomeCommand, WebotsSimulationConfig, ExecutionResultDTO> {
    ...
    @Override
    public ExecutionResultDTO execute(ExecutionCommand.ResetToHomeCommand command, WebotsSimulationConfig config) throws RoboOperationFailedException, IOException, ParseException {
