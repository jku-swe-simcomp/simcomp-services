...
public class PoseCommandExecutorTest {
    ...
    void executeCommandTest() throws RoboOperationFailedException, IOException, ParseException {
        try (MockedStatic<WebotsExecutionService> mockedService = Mockito.mockStatic(WebotsExecutionService.class)) {
            ...
            ExecutionCommand.PoseCommand command = new ExecutionCommand.PoseCommand(new PositionDTO(), new OrientationDTO());

            PoseCommandExecutor executor = new PoseCommandExecutor();
